...
const AppCategorySchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'appTasks': LinkSchema(
      id: 6412902720568165141,
      name: r'appTasks',
      target: r'AppTask',
      single: false,
      linkName: r'appCategory',
    )
  },
  embeddedSchemas: {},
...
List<IsarLinkBase<dynamic>> _appCategoryGetLinks(AppCategory object) {
  return [object.appTasks];
}

void _appCategoryAttach(
    IsarCollection<dynamic> col, Id id, AppCategory object) {
  object.id = id;
  object.appTasks.attach(col, col.isar.collection<AppTask>(), r'appTasks', id);
}
...
extension AppCategoryQueryFilter
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> colorEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> colorLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> colorBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleEqualTo(
    String value, {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'title',
        value: '',
...
extension AppCategoryQueryLinks
    on QueryBuilder<AppCategory, AppCategory, QFilterCondition> {
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition> appTasks(
      FilterQuery<AppTask> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'appTasks');
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition>
      appTasksLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'appTasks', length, true, length, true);
    });
  }
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition>
      appTasksIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'appTasks', 0, true, 0, true);
    });
  }
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition>
      appTasksIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'appTasks', 0, false, 999999, true);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition>
      appTasksLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'appTasks', 0, true, length, include);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition>
      appTasksLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'appTasks', length, include, 999999, true);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterFilterCondition>
      appTasksLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'appTasks', lower, includeLower, upper, includeUpper);
    });
  }
}
...
extension AppCategoryQuerySortBy
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> sortByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> sortByColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.desc);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppCategoryQuerySortThenBy
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> thenByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> thenByColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.desc);
    });
  }
  ...
  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<AppCategory, AppCategory, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension AppCategoryQueryWhereDistinct
  ...
  QueryBuilder<AppCategory, AppCategory, QDistinct> distinctByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'color');
    });
  }

  QueryBuilder<AppCategory, AppCategory, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppCategoryQueryProperty
  ...
  QueryBuilder<AppCategory, int, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'color');
    });
  }

  QueryBuilder<AppCategory, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
